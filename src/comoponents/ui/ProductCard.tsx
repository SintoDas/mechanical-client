...
export default function ProductCard({ product }: ProductCardProps) {
  return (
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8 grid-cols-1 p-10">
            <Card>
              ...
              <div className="flex items-center mt-2">
                ...
                <span className="ml-3 text-sm font-semibold">{product?.rating}</span>
              </div>

              <div className="flex items-center justify-between">
                <span className="text-3xl font-bold text-gray-900 dark:text-white">${product?.price}</span> {/* Display product price dynamically */}
                <Link
                  to={`/products/${product._id}`} // Link to the product details page
